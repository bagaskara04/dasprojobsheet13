...
public class NilaiMahasiswa10 {
    ...
    static void inputDataMahasiswa() {
        ...
        for (int i = 0; i < jumlahMahasiswa; i++) {
            nilaiMahasiswa[i] = new int[jumlahTugas];
    ...
    static void tampilkanNilaiMahasiswa() {
        for (int i = 0; i < jumlahMahasiswa; i++) {
            ...
            for (int j = 0; j < jumlahTugas; j++) {
                System.out.println("Tugas " + (j + 1) + ": " + nilaiMahasiswa[i][j]);
            }
            System.out.println();
        }
    }
    ...
    static void hariDenganNilaiTertinggi() {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            for (int j = 0; j < 5; j++) {
                if (nilaiMahasiswa[j][i] > max) {
                    max = nilaiMahasiswa[j][i];
                    index = j;
                }
            }
    ...
    static void mahasiswaDenganNilaiTertinggi() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; j < 7; j++) {
                if (nilaiMahasiswa[i][j] > max) {
                    max = nilaiMahasiswa[i][j];
                    index = j;
                }
            }
